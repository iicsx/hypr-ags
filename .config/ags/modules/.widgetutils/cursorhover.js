...
export function setupCursorHover(button, cursorName = "pointer") {
...
export function setupCursorHoverHResize(button) {
  // Resize left right
  setupCursorHover(button, "ew-resize");
}

export function setupCursorHoverVResize(button) {
  // Resize up down
