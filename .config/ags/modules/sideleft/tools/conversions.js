...
const conversions = [
  {
    ...
    unit1Default: 5,
    formula1to2:
      '{{x}} / (parseFloat(Utils.exec(\'gsettings get org.gnome.desktop.interface font-name\').split(" ")[1].split("\'"))*4/3)',
    formula2to1: "{{x}} * 3 / 4",
    forcePrecision: true,
  },
  {
  ...
  },
  {
    ...
    unit2: "hex",
    unit1Default: 0,
    formula1to2: "'0x' + parseInt({{x}}).toString(16).toUpperCase()",
    // formula2to1: "parseInt('{{x}}'.replace('0x', '') || 0,  16)",
    formula2to1: "{{x}}", // eval() already does this for us
  },
];
